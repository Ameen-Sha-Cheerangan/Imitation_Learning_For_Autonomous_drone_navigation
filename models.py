...
def gril():
    ...
    x = mobilenet(rgb, training = False) #todo::here in the og code it was resnet instead of mobilenet
    ...
    # Depth Channel
    depth = Input(shape=(224,224,1), name='depth')# depth = Input(shape=(224,224,3), name='depth')
